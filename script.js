...
function loadProductDetails() {
  ...
  if (thumbImage) {
    thumbImage.innerHTML = `
      <img src="${product.image}" alt="${product.name} thumbnail" loading="eager" style="width:100%;height:100%;object-fit:cover;display:block;" />
    `;
